...
## Define a summary metric to track the duration of the  /preddict data
predict_duration_summary = Summary('predictdata_request_duration_seconds','Time spent processing / predictdata requests')
...
def predict_datapoint():
    if request.method=='GET':
        ...
        with predict_duration_summary.time():
            data=CustomData(
